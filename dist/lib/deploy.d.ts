 ...
 */
export declare function findAppUUID({
  coolifyURL,
  appName,
  coolifyToken,
  logger,
 ...
 */
export declare function buildDockerImage({
  image,
  envVars,
  logger,
  context,
 ...
 */
export declare function startDeployment({
  appUUID,
  coolifyToken,
  coolifyURL,
  logger,
 ...
 */
export declare function pollDeploymentStatus({
  deploymentUUID,
  coolifyToken,
  coolifyURL,
  timeout,
 ...
 */
export declare function getAppDetails({
  appUUID,
  coolifyToken,
  coolifyURL,
  logger,
 ...
 */
export declare function updateHealthcheck({
  appUUID,
  coolifyToken,
  coolifyURL,
  healthcheckPath,
 ...
 */
export declare function verifyHealthcheck({
  fqdn,
  healthcheckPath,
  timeout,
  logger,
 ...
 */
export declare function deployApplication(
